...
export interface ApiPrice { [mint: string]: number }
...
export interface ApiAmmV3Config { data: { [id: string]: ApiAmmV3ConfigItem } }
...
export interface ApiAmmV3Pools { data: ApiAmmV3PoolsItem[] }

export interface ApiAmmV3PositionLinePoint {
  price: number,
  liquidity: number,
}
export interface ApiAmmV3PositionLine { data: ApiAmmV3PositionLinePoint[] }
